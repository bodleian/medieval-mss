...
<xsl:stylesheet exclude-result-prefixes="tei html xs" version="2.0" xmlns="http://www.w3.org/1999/xhtml" xmlns:html="http://www.w3.org/1999/xhtml" xmlns:tei="http://www.tei-c.org/ns/1.0" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xpath-default-namespace="http://www.tei-c.org/ns/1.0">
   ...
   <xsl:variable as="xs:string" name="website-url" select="'http://medieval.bodleian.ox.ac.uk'"/>
